export function currentKeyboardLanguage(language) {
  switch (language) {
    case "ru":
      return [
        [
          { value: "ё", code: "Backquote", className: "key violet" },
          { value: "1", code: "digit1", sup: "!", className: "key violet" },
          { value: "2", code: "digit2", sup: `"`, className: "key blue" },
          { value: "3", code: "digit3", sup: "№", className: "key green" },
          { value: "4", code: "digit4", sup: ";", className: "key orange" },
          { value: "5", code: "digit5", sup: "%", className: "key orange" },
          { value: "6", code: "digit6", sup: ":", className: "key yellow" },
          { value: "7", code: "digit7", sup: "?", className: "key yellow" },
          { value: "8", code: "digit8", sup: "*", className: "key green" },
          { value: "9", code: "digit9", sup: "(", className: "key blue" },
          { value: "0", code: "Digit0", sup: ")", className: "key violet" },
          { value: "-", code: "Minus", sup: "_", className: "key violet" },
          { value: "=", code: "Equal", sup: "+", className: "key violet" },
          { value: "Backspace", code: "Backspace", sup: "", className: "key sys back" },
        ],
        [
          { value: "Tab", code: "", sup: "", className: "key sys tab" },
          { value: "й", code: "KeyQ", sup: "", className: "key violet" },
          { value: "ц", code: "KeyW", sup: "", className: "key blue" },
          { value: "у", code: "KeyE", sup: "", className: "key green" },
          { value: "к", code: "KeyR", sup: "", className: "key orange" },
          { value: "е", code: "KeyT", sup: "", className: "key orange" },
          { value: "н", code: "KeyY", sup: "", className: "key yellow" },
          { value: "г", code: "KeyU", sup: "", className: "key yellow" },
          { value: "ш", code: "KeyI", sup: "", className: "key green" },
          { value: "щ", code: "KeyO", sup: "", className: "key blue" },
          { value: "з", code: "KeyP", sup: "", className: "key violet" },
          { value: "х", code: "BracketLeft", className: "key violet" },
          { value: "ъ", code: "BracketRight", className: "key violet" },
          { value: "\\", code: "Backslash", sup: "|", className: "key violet" },
        ],
        [
          { value: "CapsLock", code: "CapsLock", sup: "", className: "key sys caps" },
          { value: "ф", code: "KeyA", sup: "", className: "key violet" },
          { value: "ы", code: "KeyS", sup: "", className: "key blue" },
          { value: "в", code: "KeyD", sup: "", className: "key green" },
          { value: "а", code: "KeyF", sup: "", className: "key orange" },
          { value: "п", code: "KeyG", sup: "", className: "key orange" },
          { value: "р", code: "KeyH", sup: "", className: "key yellow" },
          { value: "о", code: "KeyJ", sup: "", className: "key yellow" },
          { value: "л", code: "KeyK", sup: "", className: "key green" },
          { value: "д", code: "KeyL", sup: "", className: "key blue" },
          { value: "ж", code: "Semicolon", className: "key violet" },
          { value: "э", code: "Quote", className: "key violet" },
          { value: "Enter", code: "Enter", sup: "", className: "key sys enter" },
        ],
        [
          { value: "Shift", code: "ShiftLeft", sup: "", className: "key sys shift" },
          { value: "я", code: "KeyZ", sup: "", className: "key violet" },
          { value: "ч", code: "KeyX", sup: "", className: "key blue" },
          { value: "с", code: "KeyC", sup: "", className: "key green" },
          { value: "м", code: "KeyV", sup: "", className: "key orange" },
          { value: "и", code: "KeyB", sup: "", className: "key orange" },
          { value: "т", code: "KeyN", sup: "", className: "key yellow" },
          { value: "ь", code: "KeyM", sup: "", className: "key yellow" },
          { value: "б", code: "Comma", className: "key green" },
          { value: "ю", code: "Period", className: "key blue" },
          { value: ".", code: "Slash", sup: ",", className: "key violet" },
    ...
    case "en":
      return [
        [
          { value: "`", code: "Backquote", sup: "~", className: "key violet" },
          { value: "1", code: "digit1", sup: "!", className: "key violet" },
          { value: "2", code: "digit2", sup: `"`, className: "key blue" },
          { value: "3", code: "digit3", sup: "№", className: "key green" },
          { value: "4", code: "digit4", sup: ";", className: "key orange" },
        ...
        [
          { value: "Tab", code: "", sup: "", className: "key sys tab" },
          { value: "q", code: "KeyQ", sup: "", className: "key violet" },
          { value: "w", code: "KeyW", sup: "", className: "key blue" },
          { value: "e", code: "KeyE", sup: "", className: "key green" },
          { value: "r", code: "KeyR", sup: "", className: "key orange" },
          { value: "t", code: "KeyT", sup: "", className: "key orange" },
          { value: "y", code: "KeyY", sup: "", className: "key yellow" },
          { value: "u", code: "KeyU", sup: "", className: "key yellow" },
          { value: "i", code: "KeyI", sup: "", className: "key green" },
          { value: "o", code: "KeyO", sup: "", className: "key blue" },
          { value: "p", code: "KeyP", sup: "", className: "key violet" },
          { value: "[", code: "BracketLeft", sup: "{", className: "key violet" },
          { value: "]", code: "BracketRight", sup: "}", className: "key violet" },
          { value: "\\", code: "Backslash", sup: "|", className: "key violet" },
        ],
        [
          { value: "CapsLock", code: "CapsLock", sup: "", className: "key sys caps" },
          { value: "a", code: "KeyA", sup: "", className: "key violet" },
          { value: "s", code: "KeyS", sup: "", className: "key blue" },
          { value: "d", code: "KeyD", sup: "", className: "key green" },
          { value: "f", code: "KeyF", sup: "", className: "key orange" },
          { value: "g", code: "KeyG", sup: "", className: "key orange" },
          { value: "h", code: "KeyH", sup: "", className: "key yellow" },
          { value: "j", code: "KeyJ", sup: "", className: "key yellow" },
          { value: "k", code: "KeyK", sup: "", className: "key green" },
          { value: "l", code: "KeyL", sup: "", className: "key blue" },
          { value: ";", code: "Semicolon", sup: ":", className: "key violet" },
          { value: "'", code: "Quote", sup: '"', className: "key violet" },
          { value: "Enter", code: "Enter", sup: "", className: "key sys enter" },
        ],
        [
          { value: "Shift", code: "ShiftLeft", sup: "", className: "key sys shift" },
          { value: "z", code: "KeyZ", sup: "", className: "key violet" },
          { value: "x", code: "KeyX", sup: "", className: "key blue" },
          { value: "c", code: "KeyC", sup: "", className: "key green" },
          { value: "v", code: "KeyV", sup: "", className: "key orange" },
          { value: "b", code: "KeyB", sup: "", className: "key orange" },
          { value: "n", code: "KeyN", sup: "", className: "key yellow" },
          { value: "m", code: "KeyM", sup: "", className: "key yellow" },
          { value: ",", code: "Comma", sup: "<", className: "key green" },
          { value: ".", code: "Period", sup: ">", className: "key blue" },
          { value: "/", code: "Slash", sup: "?", className: "key violet" },
          { value: "Shift", code: "ShiftRight", className: "key sys shift" },
        ],
        [{ value: " ", code: "Space", sup: "", className: "key sys space" }],
